...
<b>1. Обнаружение и отслеживание перемещения людей по видеозаписи</b>  
   Код: http://github.com/Leonidik/detection
...
<b>2. Создание сервиса помощи разработчику веб-приложений в подборе стандартизированных иконок</b>  
   Код: http://github.com/Leonidik/icons 
...
<b>3. Определение чистоты пищевых тарелок</b>  
   Код: http://github.com/Leonidik/clean_dirty 
...
|:---------------------------------|:--------------------------------|
|Skilfactory курсы онлайн образования (05/2022 - 11/2022) | Python - разработчик (квалификационный сертификат) |
