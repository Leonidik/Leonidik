...
<b>2. Определение чистоты пищевых тарелок (включая разработку API для серверной части проекта)</b>  
...
<b>3. Обнаружение и отслеживание перемещения людей по видеозаписи</b>  
   ...
   - Для отслеживания использовался анализ взаимного расположения объектов на соседних кадрах видео потока.
   - Сервис обеспечивает обработку и передачу обработанного видео потока в реальном времени
